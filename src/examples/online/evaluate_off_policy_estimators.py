...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="evaluate off-policy estimators with online bandit algorithms and synthetic_dataset bandit data."
    )
    parser.add_argument(
    ...
    def process(i: int):
        # synthetic_dataset data generator with uniformly random policy
        ...
        # sample new data of synthetic_dataset logged bandit feedback
