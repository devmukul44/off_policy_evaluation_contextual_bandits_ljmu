...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="evaluate the accuracy of OPE estimators on synthetic_dataset bandit data."
    )
    parser.add_argument(
    ...
    def process(i: int):
        # synthetic_dataset data generator
        ...
        # sample new training and test sets of synthetic_dataset logged bandit data
        bandit_feedback_train = dataset.obtain_batch_bandit_feedback(n_rounds=n_rounds)
        bandit_feedback_test = dataset.obtain_batch_bandit_feedback(n_rounds=n_rounds)
        # train the evaluation policy on the training set of the synthetic_dataset logged bandit data
        ...
        # predict the action decisions for the test set of the synthetic_dataset logged bandit data
        action_dist = evaluation_policy.predict_proba(
            context=bandit_feedback_test["context"],
        )
        # estimate the reward function of the test set of synthetic_dataset bandit feedback with ML model
